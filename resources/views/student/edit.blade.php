                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('student.update',$student->id) }}">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="tempat_lahir" type="tempat_lahir" class="form-control @error('Tempat_lahir') is-invalid @enderror" name="tempat_lahir" required autocomplete="tempat_lahir" autofocus>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="tanggal_lahir" type="date" class="form-control @error('Tempat_Lahir') is-invalid @enderror" name="tanggal_lahir" required autocomplete="tanggal_lahir" autofocus>
